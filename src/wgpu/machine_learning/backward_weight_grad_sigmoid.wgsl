@group(0) @binding(0)
var<storage, read> input: array<f32>; //self_weights, grad_output, sigmoid_cache, linear_cache
...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>){
	...
	let sigmoid_cache_offset = grad_offset + shapes[2] * shapes[3];
	let linear_cache_offset = sigmoid_cache_offset + shapes[4] * shapes[5];
